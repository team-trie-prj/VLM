...
vlm/
  ...
  cli.py         # CLI (analyze/batch/query/vqa/compare/doctor/info)
  backends/      # mock / gemini / anthropic / openai / qwen
config/default.yaml
scripts/  make_sample_images.py · fetch_roboflow.py
tests/  test_mock.py · test_compare.py · test_api_backends.py
```
